...
public anywheresoftware.b4a.objects.ScrollViewWrapper _vvvvvvvvvvv0 = null;
...
_simoperator.setObject((java.util.List)(_offers.Get((Object)(mostCurrent._vvvvvvvvvvv6._vvv0))));
...
_vvvvvvvvvvv7 = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (220));
 }else {
 //BA.debugLineNum = 43;BA.debugLine="iPanelHeight = 180dip";
_vvvvvvvvvvv7 = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (180));
 };
 //BA.debugLineNum = 45;BA.debugLine="sv.Initialize((SIMOperator.Size * iPanelHeight)";
mostCurrent._vvvvvvvvvvv0.Initialize(mostCurrent.activityBA,(int) ((_simoperator.getSize()*_vvvvvvvvvvv7)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
...
mostCurrent._vvvvvvvvvvv0.getPanel().AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))+(_i*_vvvvvvvvvvv7)),mostCurrent._vvvvvvvvvvv0.getWidth(),_vvvvvvvvvvv7);
...
_lblmessage.setTypeface((android.graphics.Typeface)(mostCurrent._vvvvvvvvvvv6._vvv7.getObject()));
...
_pnl.AddView((android.view.View)(_lblmessage.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_lbltitle.getTop()+_lbltitle.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),(int) (_pnl.getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))),mostCurrent._vvvvvvvvvvv6._wrap_content);
...
mostCurrent._vvvvvvvv1.getOptions().Elements.Title.Typeface = (android.graphics.Typeface)(mostCurrent._vvvvvvvvvvv6._vvv7.getObject());
 //BA.debugLineNum = 131;BA.debugLine="Dialog.Options.Elements.Message.Typeface = Main.";
mostCurrent._vvvvvvvv1.getOptions().Elements.Message.Typeface = (android.graphics.Typeface)(mostCurrent._vvvvvvvvvvv6._vvv7.getObject());
 //BA.debugLineNum = 132;BA.debugLine="Dialog.Options.Elements.Buttons.Default.Style.Ty";
mostCurrent._vvvvvvvv1.getOptions().Elements.Buttons.Default.Style.Typeface = (android.graphics.Typeface)(mostCurrent._vvvvvvvvvvv6._vvv7.getObject());
 //BA.debugLineNum = 133;BA.debugLine="Dialog.Msgbox(\"သတိေပးခ်က္\", \"ဝန္ေဆာင္မႈ မရွိေသးပ";
mostCurrent._vvvvvvvv1.MsgBox(mostCurrent.activityBA,"သတိေပးခ်က္","ဝန္ေဆာင္မႈ မရွိေသးပါ။","အိုေက","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
...
mostCurrent._vvvvvvv5.Send(_a.PhoneNumber,_a.Activation);
...
mostCurrent._vvvvvvv5.Send(_a.PhoneNumber,_a.Deactivation);
...
mostCurrent._vvvvvvvvvvv0 = new anywheresoftware.b4a.objects.ScrollViewWrapper();
