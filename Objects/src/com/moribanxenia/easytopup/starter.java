...
public class starter extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.moribanxenia.easytopup", "com.moribanxenia.easytopup.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.moribanxenia.easytopup.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static anywheresoftware.b4a.objects.FirebaseAnalyticsWrapper _vvv3 = null;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 7;BA.debugLine="Public Analytics As FirebaseAnalytics";
_vvv3 = new anywheresoftware.b4a.objects.FirebaseAnalyticsWrapper();
 //BA.debugLineNum = 8;BA.debugLine="End Sub";
return "";
}
public static String  _service_create() throws Exception{
 //BA.debugLineNum = 10;BA.debugLine="Sub Service_Create";
 //BA.debugLineNum = 11;BA.debugLine="Analytics.Initialize";
_vvv3.Initialize();
