...
public static Object[]  _vv4(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
...
public static String  _vv5(anywheresoftware.b4a.BA _ba,String _key) throws Exception{
 //BA.debugLineNum = 28;BA.debugLine="Sub GetSetting(Key As String)";
 //BA.debugLineNum = 29;BA.debugLine="Return GetSetting2(Key, \"\")";
if (true) return _vv6(_ba,_key,"");
 //BA.debugLineNum = 30;BA.debugLine="End Sub";
return "";
}
public static String  _vv6(anywheresoftware.b4a.BA _ba,String _key,String _defaultvalue) throws Exception{
String _v = "";
...
public static String  _vv7(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
...
_vv7(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
...
_vv7(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
...
_vv7(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
anywheresoftware.b4a.objects.EditTextWrapper _edit = null;
anywheresoftware.b4a.objects.SpinnerWrapper _spinner1 = null;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _check = null;
...
_vv0(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
 }else if(_v.getObjectOrNull() instanceof android.widget.ScrollView) { 
...
_vv0(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
 }else if(_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
...
_vv0(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
_vv1 = BA.__b (new byte[] {32,52,-65,-95,39,112,-92,-20,39}, 225743);
 //BA.debugLineNum = 8;BA.debugLine="settingsFileName = \"settings.properties\"";
_vv2 = BA.__b (new byte[] {32,37,49,-30,43,48,60,-67,125,33,42,-82,37,36,51,-83,104,49,59}, 37119);
 //BA.debugLineNum = 9;BA.debugLine="Dim settings As Map";
_vv3 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 10;BA.debugLine="End Sub";
return "";
}
public static String  _vvv2(anywheresoftware.b4a.BA _ba,String _activityname) throws Exception{
...
public static boolean  _vvv3(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname,int _validperiodinminutes) throws Exception{
...
_vv7(_ba,_activity.GetView(_i),_list1);
 }
};
...
public static String  _vvv5(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname) throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
int _i = 0;
...
_vv0(_ba,_activity.GetView(_i),_list1);
 }
};
...
public static String  _vvv6(anywheresoftware.b4a.BA _ba,String _key,String _value) throws Exception{
