...
public static Object[]  _vvvvvvvvvvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
...
public static String  _vvvvvvvvvvvv1(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
...
_data = _vvvvvvvvvvv0(_ba,_list1);
...
_vvvvvvvvvvvv1(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
...
_vvvvvvvvvvvv1(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
...
_vvvvvvvvvvvv1(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvvvvvvvvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
anywheresoftware.b4a.objects.EditTextWrapper _edit = null;
anywheresoftware.b4a.objects.SpinnerWrapper _spinner1 = null;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _check = null;
...
_vvvvvvvvvvvv2(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
 }else if(_v.getObjectOrNull() instanceof android.widget.ScrollView) { 
...
_vvvvvvvvvvvv2(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
 }else if(_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
...
_vvvvvvvvvvvv2(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvvvvvvvvvv3(anywheresoftware.b4a.BA _ba) throws Exception{
...
_vv1 = BA.__b (new byte[] {35,54,-109,7,36,115,-119,74,37}, 759112);
 //BA.debugLineNum = 8;BA.debugLine="settingsFileName = \"settings.properties\"";
_vv2 = BA.__b (new byte[] {35,38,52,119,40,50,56,40,127,34,46,58,38,39,54,56,107,51,63}, 45335);
...
_vvvvvvvvvvvv1(_ba,_activity.GetView(_i),_list1);
 }
};
...
_vvvvvvvvvvvv2(_ba,_activity.GetView(_i),_list1);
 }
};
...
public static String  _vvvvvvvvvvvv4(anywheresoftware.b4a.BA _ba) throws Exception{
anywheresoftware.b4a.randomaccessfile.RandomAccessFile _raf = null;
