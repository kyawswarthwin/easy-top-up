...
public static Object[]  _vvvvvvvvvvvv5(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
...
if (true) return (Object[])(_list1.Get(_v0));
 //BA.debugLineNum = 206;BA.debugLine="End Sub";
return null;
}
public static String  _vv4(anywheresoftware.b4a.BA _ba,String _key) throws Exception{
...
if (true) return _vv5(_ba,_key,"");
 //BA.debugLineNum = 30;BA.debugLine="End Sub";
return "";
}
public static String  _vv5(anywheresoftware.b4a.BA _ba,String _key,String _defaultvalue) throws Exception{
String _v = "";
...
if (_vv3.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 16;BA.debugLine="If File.Exists(File.DirInternal, settingsFileNam";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv2)) { 
 //BA.debugLineNum = 17;BA.debugLine="settings = File.ReadMap(File.DirInternal, setti";
_vv3 = anywheresoftware.b4a.keywords.Common.File.ReadMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv2);
 }else {
...
_v = BA.ObjectToString(_vv3.GetDefault((Object)(_key.toLowerCase()),(Object)(_defaultvalue)));
 //BA.debugLineNum = 24;BA.debugLine="Return v";
if (true) return _v;
 //BA.debugLineNum = 25;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvv6(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
...
_data = _vvvvvvvvvvvv5(_ba,_list1);
...
_vvvvvvvvvvvv6(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
...
_vvvvvvvvvvvv6(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
...
_vvvvvvvvvvvv6(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvvvvvvvvvv7(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _v,anywheresoftware.b4a.objects.collections.List _list1) throws Exception{
Object[] _data = null;
anywheresoftware.b4a.objects.EditTextWrapper _edit = null;
anywheresoftware.b4a.objects.SpinnerWrapper _spinner1 = null;
anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _check = null;
...
_vvvvvvvvvvvv7(_ba,_tabparentpanel.GetView(_i),_list1);
 }
};
 }else if(_v.getObjectOrNull() instanceof android.widget.ScrollView) { 
...
_vvvvvvvvvvvv7(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_sv.getPanel().getObject())),_list1);
 }else if(_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
...
_vvvvvvvvvvvv7(_ba,_panel1.GetView(_i),_list1);
 }
};
 };
...
public static String  _vvvvvvvvvvvv0(anywheresoftware.b4a.BA _ba) throws Exception{
...
_raf.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv1,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 243;BA.debugLine="states = raf.ReadObject(0)";
_v7.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_raf.ReadObject((long) (0))));
...
_vv1 = BA.__b (new byte[] {34,55,102,-37,37,113,127,-106,39}, 614442);
 //BA.debugLineNum = 8;BA.debugLine="settingsFileName = \"settings.properties\"";
_vv2 = BA.__b (new byte[] {34,39,-20,-104,41,48,-29,-57,125,35,-11,-42,39,38,-18,-41,106,49,-28}, 344279);
...
_v7.Remove((Object)(_activityname.toLowerCase()));
...
public static boolean  _vv7(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname,int _validperiodinminutes) throws Exception{
...
if (_v7.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
...
_list1.setObject((java.util.List)(_v7.Get((Object)(_activityname.toLowerCase()))));
...
_vvvvvvvvvvvv6(_ba,_activity.GetView(_i),_list1);
 }
};
...
if (_vv3.IsInitialized()) { 
 //BA.debugLineNum = 47;BA.debugLine="File.WriteMap(File.DirInternal, settingsFileName";
anywheresoftware.b4a.keywords.Common.File.WriteMap(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),_vv2,_vv3);
 };
 //BA.debugLineNum = 49;BA.debugLine="End Sub";
return "";
}
public static String  _vvv1(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ActivityWrapper _activity,String _activityname) throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
int _i = 0;
...
_vvvvvvvvvvvv7(_ba,_activity.GetView(_i),_list1);
 }
};
 //BA.debugLineNum = 68;BA.debugLine="states.Put(ActivityName.ToLowerCase, list1)";
_v7.Put((Object)(_activityname.toLowerCase()),(Object)(_list1.getObject()));
 //BA.debugLineNum = 69;BA.debugLine="writeStateToFile";
_vvvvvvvvvvvvv1(_ba);
 //BA.debugLineNum = 70;BA.debugLine="End Sub";
return "";
}
public static String  _vvv2(anywheresoftware.b4a.BA _ba,String _key,String _value) throws Exception{
...
_vv3.Put((Object)(_key.toLowerCase()),(Object)(_value));
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvvv1(anywheresoftware.b4a.BA _ba) throws Exception{
anywheresoftware.b4a.randomaccessfile.RandomAccessFile _raf = null;
...
_raf.WriteObject((Object)(_v7.getObject()),anywheresoftware.b4a.keywords.Common.True,_raf.CurrentPosition);
