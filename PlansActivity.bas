...
Sub Globals
	...
	Private iPanelHeight As Int = 200dip
...
Sub Activity_Create(FirstTime As Boolean)
	...
	Try
		parser.Initialize(File.ReadString(File.DirAssets, "database.json"))
		...
		For i = 0 To SIMOperator.Size - 1
			...
			lblTitle.Initialize("")
			lblTitle.Text = colSIMOperator.Get("Offer")
			lblTitle.Typeface = Typeface.DEFAULT_BOLD
			lblTitle.TextSize = 20
			pnl.AddView(lblTitle, 10dip, 10dip, pnl.Width - 20dip, 30dip)
			
			lblMessage.Initialize("")
			lblMessage.Text = "ေဈးႏႈန္း: " & colSIMOperator.Get("price") & CRLF & "Voice: " & colSIMOperator.Get("voice") & CRLF & "SMS: " & colSIMOperator.Get("sms") & CRLF & "Internet: " & colSIMOperator.Get("internet") & CRLF & "အက်ံဳးဝင္သည့္ကာလ: " & colSIMOperator.Get("validityPeriod")
			...
			pnl.AddView(btnDeactivate, 10dip, pnl.Height - 50dip, (pnl.Width / 2) - 15dip, 40dip)
